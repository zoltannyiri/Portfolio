...
const englishTranslations = {
  ...
  "Modern weboldalakat és mobilalkalmazásokat készítek vállalkozásoknak az ötlettől a működő termékig.": "I build modern websites and mobile applications for businesses, from the initial idea to a working product.",
  "Kapcsolatfelvétel": "Get in touch",

  "Üdvözöllek! Nyiri Zoltán vagyok, webfejlesztő és mobil alkalmazás fejlesztő. Szenvedélyem a technológia és az innováció, és mindig arra törekszem, hogy a legjobb megoldásokat nyújtsam. Tanulmányaim többek között a győri Jedlik Ányos Szakgimnáziumban töltöttem, ahol CAD-CAM programozó szakképesítést szereztem, majd a győri Széchenyi István Egyetemen folytattam, ahol mérnökinformatikus diplomát szereztem. Egyetemi éveim alatt mélyreható ismereteket szereztem többek között a szoftverfejlesztés, az adatbázis-kezelés és a webes technológiák terén, ugyanakkor a gyakorlati tapasztalatok megszerzése érdekében számos projektben vettem részt, amelyek során lehetőségem nyílt a valós problémák megoldására és az ügyfélközpontú megközelítésre.": "Welcome! I'm Zoltán Nyiri, a web and mobile application developer. I am passionate about technology and innovation, and I always strive to provide the best possible solutions. I studied at Jedlik Ányos Vocational Secondary School in Győr, where I earned a CAD-CAM programming qualification, and then continued at Széchenyi István University in Győr, where I earned a degree in Computer Science Engineering. During my university studies, I gained in-depth knowledge of software development, database management, and web technologies. I also worked on numerous projects that gave me practical experience in solving real-world problems with a client-centered approach.",
  ...
  "Egy fejlesztés alatt álló interaktív, túraútvonalakat listázó weboldal, ahol a felhasználók különböző típusú túrákra jelentkezhetnek, fizetést bonyolíthatnak le, cseveghetnek egymással és megoszthatják saját tapasztalataikat.": "An interactive hiking website under development that lists trails and allows users to sign up for different types of hikes, make payments, chat with one another, and share their experiences.",
  ...
  "Magyarország egyik leghíresebb autós fesztiváljának bemutatkozó weboldala, amely a rendezvény részleteit, programjait és az élőben történő szavazási funkcióját tartalmazza.": "A website for one of Hungary's best-known car festivals, featuring event details, programs, and live voting.",
  "Kevesebb": "Show less",
  "további": "more",
